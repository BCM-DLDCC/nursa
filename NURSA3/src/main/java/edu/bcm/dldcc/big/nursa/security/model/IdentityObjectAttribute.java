...
public class IdentityObjectAttribute implements Serializable {
    ...
    @Id
    @GeneratedValue(generator = "identityObjectAttributeSequencer")
	@SequenceGenerator(name = "identityObjectAttributeSequencer", sequenceName = "IDENTITYOBJECTATTRIBUTE_SEQ", initialValue=100)
