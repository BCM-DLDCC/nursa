...
public abstract class AnnotationLazyLoader<T, A extends BaseAnnotation>
	...
	private List<Long> getIds(Map<String, String> filters, String joinField) {
	 ...
	 */
	private Predicate createGlobalFilter(Map<String, String> theFilters,
		...
		if (!theFilters.isEmpty()) {
			...
			for (String stringPath : theFilters.keySet()) {
				...
				// value
				restrictions = cb.and(restrictions,
						cb.equal(finalPath, theFilters.get(stringPath)));
			}
