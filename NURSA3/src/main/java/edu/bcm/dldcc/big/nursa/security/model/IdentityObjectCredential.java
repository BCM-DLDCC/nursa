...
public class IdentityObjectCredential implements Serializable {
    ...
    @Id
    @GeneratedValue(generator = "identityCredentialSequencer")
	@SequenceGenerator(name = "identityCredentialSequencer", sequenceName = "IDENTITYCREDENTIAL_SEQ", initialValue=100)
    public Long getId() {
        return id;
    }
