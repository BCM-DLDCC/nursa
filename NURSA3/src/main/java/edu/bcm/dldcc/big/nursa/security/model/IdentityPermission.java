...
public class IdentityPermission implements Serializable {
     ...
     */
    @Id
    @GeneratedValue(generator = "identityPermissionSequencer")
	@SequenceGenerator(name = "identityPermissionSequencer", sequenceName = "IDENTITYPERMISSION_SEQ", initialValue=100)
    public Long getId() {
        return id;
    }
