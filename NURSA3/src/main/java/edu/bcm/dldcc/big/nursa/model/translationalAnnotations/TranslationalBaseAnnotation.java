...
public class TranslationalBaseAnnotation extends BaseAnnotation {

	private static final long serialVersionUID = -3972656557388170400L;

	@Id
	@GeneratedValue(generator = "transbaseAnnotationSequencer")
	@SequenceGenerator(name = "transbaseAnnotationSequencer", sequenceName = "TRANSBA_SEQ")
	private Long id;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TranslationalBaseAnnotation other = (TranslationalBaseAnnotation) obj;
