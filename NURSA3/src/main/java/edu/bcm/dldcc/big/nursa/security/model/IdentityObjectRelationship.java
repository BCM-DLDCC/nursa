...
public class IdentityObjectRelationship implements Serializable {
    ...
    @Id
    @GeneratedValue(generator = "identityObjectRelationshipSequencer")
	@SequenceGenerator(name = "identityObjectRelationshipSequencer", sequenceName = "IDENTITYOBJECTRELATIONSHIP_SEQ", initialValue=100)
    public Long getId() {
        return id;
    }
